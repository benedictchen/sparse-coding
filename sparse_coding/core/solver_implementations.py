"""
Research-accurate solver implementations for sparse coding.

Implements all FIXME solutions from interfaces.py:
1. Pure Protocol Interface (Solution 1) - already done in interfaces.py  
2. Separate Concrete Solver Classes (Solution 2)
3. Solver Factory Pattern (Solution 3)
4. Registry-Based Solver System (Solution 4)
