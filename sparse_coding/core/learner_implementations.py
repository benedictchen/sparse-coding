...
2. Concrete Learner Implementations (Solution 2)
3. Composite Learner Pattern (Solution 3)
...
from .penalty_implementations import L1Penalty, create_penalty, PenaltyConfig
