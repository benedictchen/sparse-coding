...
try:
    ...
    from factories.algorithm_factory import create_penalty, create_solver, create_complete_learner
...
def test_complete_learner():
    """Test complete dictionary learning system"""
    print("Testing complete dictionary learner...")
