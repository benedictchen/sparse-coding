"""
Unified configuration system for sparse coding algorithms.

Provides configuration options allowing users to select between:
- Architectural patterns (Pure Protocols, ABC, Composition, Registry, Factory)
- Algorithm implementations  
- Overlapping solution approaches with config options

This system implements sparse coding algorithms with unified configuration.
"""
...
from .penalties import (
    L1Penalty, L2Penalty, ElasticNetPenalty, CauchyPenalty, PenaltyProtocol
)
...
class ArchitecturalPattern(Enum):
    """Architectural patterns for sparse coding systems."""
...
class SparseCodingConfig:
    """
    Configuration for sparse coding systems.
...
# Factory for creating sparse coding systems
class SparseCodingFactory:
    """
    Factory for configuring sparse coding systems.
    
    Creates sparse coding systems using combinations
