...
from sparse_coding.advanced_optimization import create_advanced_sparse_coder
from sparse_coding.visualization import create_comprehensive_report
...
def main():
    ...
    print(f"\n{'='*50}")
    print("STEP 3: ADVANCED OPTIMIZATION METHODS")
    print(f"{'='*50}")
    ...
    print(f"\n{'='*50}")
    print("STEP 4: COMPREHENSIVE VISUALIZATION & ANALYSIS")
    print(f"{'='*50}")
